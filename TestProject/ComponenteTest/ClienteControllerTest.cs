...
//                $"api/Cliente/{_Cliente.IdCliente}");
...
//                $"api/Cliente/{_Cliente.IdCliente}", _Cliente);
...
//            var client = _apiTest.GetClient();
//            HttpResponseMessage response = await client.PostAsJsonAsync(
//                $"api/Cliente/consult", new PagingQueryParam<Cliente> { ObjFilter = _Cliente });
